...
BEGIN
    ...
    -- If conditions are not true, allow the insertion of orders
...
INSERT INTO CustomerOrder (CustomerID, RestaurantID, OrderDate, OrderTime, OrderStatus, 
                        PickupTime, DeliveryTime, Comments, DeliveryExecutiveID) 
VALUES
...
INSERT INTO CustomerOrder (CustomerID, RestaurantID, OrderDate, OrderTime, OrderStatus, PickupTime,
 DeliveryTime, Comments, DeliveryExecutiveID) VALUES
...
INSERT INTO CustomerOrder (CustomerID, RestaurantID, OrderDate, OrderTime, OrderStatus, 
                           PickupTime, DeliveryTime, Comments, DeliveryExecutiveID)
VALUES
    (1010, 1012, '2024-04-12', '20:00:00', 'Preparing', '20:15:00', '20:40:00', 'Give Extra sauce packets', 1008);
...
INSERT INTO Review (ReviewDescription, Rating, CustomerOrderID)
VALUES
    ('Excellent food!', 4, 1033);


INSERT INTO Review (ReviewDescription, Rating, CustomerOrderID)
VALUES
    ('The food was delicious!', 4, 1005);
GO
...
EXEC GenerateInvoice @CustomerOrderID = 1001;
GO
...
EXEC GetOrderHistory @CustomerID = 1006; 
GO
...
/*View to display Restaurant Order Summary like 
